...
SELECT * from [TB_PRODUTOS] WHERE SUBSTRING([DESCRITOR],1,15) = 'Sabor dos Alpes'

DELETE FROM TB_PRODUTOS WHERE CODIGO = 1001000;

SELECT * from TB_PRODUTOS WHERE SUBSTRING(DESCRITOR,1,15) = 'Sabor dos Alpes' AND TAMANHO = '1 Litro';

DELETE FROM TB_PRODUTOS WHERE SUBSTRING([DESCRITOR],1,15) = 'Sabor dos Alpes' AND TAMANHO = '1 Litro';
